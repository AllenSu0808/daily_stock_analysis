...
使用方法：
    python scripts/check_env.py              # 運行所有測試
    python scripts/check_env.py --db         # 僅查看數據庫
    python scripts/check_env.py --llm        # 僅測試 LLM
    python scripts/check_env.py --fetch      # 僅測試數據獲取
