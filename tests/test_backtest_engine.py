...
class BacktestEngineTestCase(unittest.TestCase):
    ...
    def test_bearish_like_phrases_match_keyword_substring(self):
        self.assertEqual(
            BacktestEngine.infer_position_recommendation("建議買入"),
            "long",
        )
        self.assertEqual(
    ...
    def test_range_bound_watch_is_treated_as_hold_long_path(self):
        self.assertEqual(
            BacktestEngine.infer_position_recommendation("震蕩觀望"),
            "long",
        )
        self.assertEqual(
    ...
    def test_wait_phrase_before_bullish_phrases_stays_wait(self):
        self.assertEqual(
            BacktestEngine.infer_position_recommendation("先觀望再買入"),
            "cash",
        )
        self.assertEqual(
            BacktestEngine.infer_direction_expected("先觀望再買入"),
            "flat",
        )
        self.assertEqual(
            BacktestEngine.infer_position_recommendation("觀望後買入"),
            "cash",
        )
        self.assertEqual(
            BacktestEngine.infer_direction_expected("觀望後買入"),
            "flat",
        )
