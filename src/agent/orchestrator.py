...
class AgentOrchestrator:
    ...
    def _normalize_dashboard_payload(
        ...
        if not analysis_summary:
            analysis_summary = f"多 Agent 未生成完整儀錶盤，當前按{_signal_to_operation(decision_type)}處理。"
