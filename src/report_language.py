...
_OPERATION_ADVICE_TRANSLATIONS = {
    "strong_buy": {"zh": "强烈买入", "en": "Strong Buy", "zh-tw": "強烈買入"},
    ...
    "strong_sell": {"zh": "强烈卖出", "en": "Strong Sell", "zh-tw": "強烈賣出"},
}
...
_TREND_PREDICTION_TRANSLATIONS = {
    "strong_bullish": {"zh": "强烈看多", "en": "Strong Bullish", "zh-tw": "強烈看多"},
    "bullish": {"zh": "看多", "en": "Bullish", "zh-tw": "看多"},
    "sideways": {"zh": "震荡", "en": "Sideways", "zh-tw": "震盪"},
    "bearish": {"zh": "看空", "en": "Bearish", "zh-tw": "看空"},
    "strong_bearish": {"zh": "强烈看空", "en": "Strong Bearish", "zh-tw": "強烈看空"},
}
...
_BIAS_STATUS_TRANSLATIONS = {
    ...
    "danger": {"zh": "危险", "en": "Danger", "zh-tw": "危險"},
}
