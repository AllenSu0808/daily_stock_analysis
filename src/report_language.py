...
SUPPORTED_REPORT_LANGUAGES = ("zh", "en", "zh-tw")
...
_OPERATION_ADVICE_TRANSLATIONS = {
    "strong_buy": {"zh": "強烈買入", "en": "Strong Buy", "zh-tw": "強烈買入"},
    "buy": {"zh": "買入", "en": "Buy", "zh-tw": "買入"},
    "hold": {"zh": "持有", "en": "Hold", "zh-tw": "持有"},
    "watch": {"zh": "觀望", "en": "Watch", "zh-tw": "觀望"},
    "reduce": {"zh": "減倉", "en": "Reduce", "zh-tw": "減倉"},
    "sell": {"zh": "賣出", "en": "Sell", "zh-tw": "賣出"},
    "strong_sell": {"zh": "強烈賣出", "en": "Strong Sell", "zh-tw": "強烈賣出"},
}
...
_TREND_PREDICTION_TRANSLATIONS = {
    "strong_bullish": {"zh": "強烈看多", "en": "Strong Bullish", "zh-tw": "強烈看多"},
    "bullish": {"zh": "看多", "en": "Bullish", "zh-tw": "看多"},
    "sideways": {"zh": "震蕩", "en": "Sideways", "zh-tw": "震盪"},
    "bearish": {"zh": "看空", "en": "Bearish", "zh-tw": "看空"},
    "strong_bearish": {"zh": "強烈看空", "en": "Strong Bearish", "zh-tw": "強烈看空"},
}
...
_CONFIDENCE_LEVEL_TRANSLATIONS = {
    "high": {"zh": "高", "en": "High", "zh-tw": "高"},
    "medium": {"zh": "中", "en": "Medium", "zh-tw": "中"},
    "low": {"zh": "低", "en": "Low", "zh-tw": "低"},
}
...
_CHIP_HEALTH_TRANSLATIONS = {
    "healthy": {"zh": "健康", "en": "Healthy", "zh-tw": "健康"},
    "average": {"zh": "一般", "en": "Average", "zh-tw": "一般"},
    "caution": {"zh": "警惕", "en": "Caution", "zh-tw": "警惕"},
}
...
_BIAS_STATUS_TRANSLATIONS = {
    "safe": {"zh": "安全", "en": "Safe", "zh-tw": "安全"},
    "caution": {"zh": "警戒", "en": "Caution", "zh-tw": "警戒"},
    "danger": {"zh": "危險", "en": "Danger", "zh-tw": "危險"},
}
